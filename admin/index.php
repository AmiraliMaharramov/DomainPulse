...
<head>
    ...
    <title>BD Domain Takip Sistemi</title>
        ...
        <div class="container">
            <div class="header-content">
                ...
                <nav style="flex: 1; display: flex; justify-content: center; align-items: center;">
                    <a href="index.php" style="color: white; text-decoration: none; font-weight: 500; padding: 0.5rem 1rem; border-radius: var(--radius-sm); transition: all 0.3s ease; background: rgba(255, 255, 255, 0.1);">
                ...
                <div class="panel-header">
                    ...
                    <div class="panel-actions">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; width: 100%;">
                            ...
                            <a href="hosting-takip.php" class="btn btn-secondary" title="Hosting Takip">
                                <i class="fas fa-cloud"></i> Hosting Takip
                            </a>
